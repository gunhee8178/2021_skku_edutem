...
def main(args, init_distributed=False):
    ...
    with open("/home/ubuntu/workspace/edutem/ai/bertgec_gun/bert-gec/data/loss/loss.txt", "w") as lt:
        ...
        while lr > args.min_lr and epoch_itr.epoch < max_epoch and trainer.get_num_updates() < max_update:
            # train for one epoch
            start = time.time()
            print(epoch_itr.epoch, "th epoch training starts")
            ...
            lt.write(str(epoch_itr.epoch)+ "th epoch\n\tloss (lr) : " + str(lr) +"\n\tvalid losses[0]"+ str(valid_losses[0]) + "\n\ttime : "+str( time.time()-start ) + "\n")
            ...
            print(epoch_itr.epoch-1, "th epoch training ends")
        train_meter.stop()
